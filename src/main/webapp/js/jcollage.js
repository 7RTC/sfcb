function Collage(canvasId) {
    ...
    scaleImg.src = "imagens/resize.png";
    rotateImg.src = "imagens/rotate.png";
...
function calculateAspectRatioFit(srcWidth, srcHeight) {
    ...
    var ratio = Math.min(600 / srcWidth, 600 / srcHeight);
...
function Layer(img) {
    ...
    var aspectRatio = calculateAspectRatioFit(img.naturalWidth, img.naturalHeight);

    this.width = aspectRatio.width / 2;
    this.height = aspectRatio.height / 2;
