...
<body>
	...
	<img alt="colagem" class="colagemSucesso" src="<% out.println(request.getAttribute("imagemBase64Src")); %>">
	
	<a href="/colagem" id="novaColagem" class="botaoGenerico">GERAR NOVA COLAGEM</a>
	<a href="https://www.facebook.com/<% out.println(request.getAttribute("idUsuario")); %>/posts/<% out.println(request.getAttribute("idPost")); %>" target="blank" id="colagemFacebook" class="botaoGenerico">VER COLAGEM NO FACEBOOK</a>
